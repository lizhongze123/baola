...
/**
 * 基于原版(https://github.com/wangjiegulu/WheelView)作了一下修改： 去掉回弹阴影 修正以便支持联动效果 可设置颜色
 * 设置文字大小 分隔线是否可见 初始设置选中选项
 *
 * @author 麦森
 * @ClassName WheelView
 * @Description
 * @date 2016-6-27 下午1:26:09
 */
public class WheelView extends ScrollView {
     ...
     * 开始时间
     */
    public static final int BEGIN_COLOR = 0XFF01B31E;
    /**
     * 结束时间
     */
    public static final int END_COLOR = 0XFFEB6100;
    /**
    ...
    private TextView createView(String item) {
        ...
        tv.setPadding(padding, dip2px(5), padding, dip2px(5));
        if (0 == itemHeight) {
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        // LogUtils.debug(this, "w: " + w + ", h: " + h + ", oldw: " + oldw +
        // ", oldh: " + oldh);
        viewWidth = w;
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        switch (ev.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                // LogUtils.debug(this, String.format("items=%s, offset=%s",
                // items.size(), offset));
    ...
    private class ScrollerTask implements Runnable {
        ...
        public void run() {
            ...
            if (initialY - newY == 0) { // stopped
                ...
                // LogUtils.debug(this, "initialY: " + initialY +
                // ", remainder: " + remainder + ", divided: " + divided);
                if (remainder == 0) {
