package com.XMBT.bluetooth.le.view.datePicker.popup;
 ...
 * @Description 带确定及取消按钮的
 * @date 2016-6-27 下午1:41:51
 */
public abstract class ConfirmPopup<V extends View> extends BottomPopup<View> {
    ...
    protected int cancelTextColor = 0XFFBBBBBB;
    protected int submitTextColor = 0XFFEB6100;
    ...
    protected final View makeContentView() {
        ...
        rootLayout.setLayoutParams(new LinearLayout.LayoutParams(MATCH_PARENT,
                MATCH_PARENT));
        ...
        rootLayout.addView(makeCenterView(), new LinearLayout.LayoutParams(
                MATCH_PARENT, 0, 1.0f));
    ...
    protected View makeHeaderView() {
        ...
        topButtonLayout.setLayoutParams(new RelativeLayout.LayoutParams(
                MATCH_PARENT, ConvertUtils.toPx(activity, 40)));
        ...
        cancelButtonLayoutParams.addRule(RelativeLayout.ALIGN_PARENT_LEFT,
                RelativeLayout.TRUE);
        cancelButtonLayoutParams.addRule(RelativeLayout.CENTER_VERTICAL,
                RelativeLayout.TRUE);
        ...
        cancelButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                onCancel();
                if(onButtonClickListener != null && onButtonClickListener.onButtonClick(false)){
                    return;
                }
                dismiss();
            }
        ...
        RelativeLayout.LayoutParams submitButtonLayoutParams = new RelativeLayout.LayoutParams(
                WRAP_CONTENT, WRAP_CONTENT);
        submitButtonLayoutParams.addRule(RelativeLayout.ALIGN_PARENT_RIGHT,
                RelativeLayout.TRUE);
        submitButtonLayoutParams.addRule(RelativeLayout.CENTER_VERTICAL,
                RelativeLayout.TRUE);
        ...
        submitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                onSubmit();
                if(onButtonClickListener != null && onButtonClickListener.onButtonClick(true)){
                    return;
                }
                dismiss();
            }
    ...
    public static interface OnButtonClickListener{
        boolean onButtonClick(boolean isSubmit);
    }
}
