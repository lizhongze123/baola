...
import com.XMBT.bluetooth.le.view.datePicker.popup.ConfirmPopup;
...
public abstract class WheelPicker extends ConfirmPopup<View> {
    ...
    // 开始字体颜色
    protected int beginTextColor = WheelView.BEGIN_COLOR;
    // 结束时间字体颜色
    protected int endTextColor = WheelView.END_COLOR;
    /**
     * The Line visible.
     */
     ...
     */
    public void setTextColor(@ColorInt int textColorFocus,
