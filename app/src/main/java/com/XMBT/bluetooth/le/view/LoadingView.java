...
public class LoadingView extends View {
    ...
    private void obtainStyledAttrs(Context context, AttributeSet attrs) {
        ...
        textColor = array.getColor(R.styleable.a_zhon_textColor, Color.WHITE);
        percentText = array.getString(R.styleable.a_zhon_percentText);
        array.recycle();
    }
...
//        bfPaint.setStrokeCap(Paint.Cap.ROUND);
        cirPaint = new Paint();
        cirPaint.setAntiAlias(false);
        cirPaint.setColor(beforePaintColor);

        textPaint = new Paint();
        textPaint.setColor(textColor);
        textPaint.setAntiAlias(true);
//        textPaint.setTextAlign(Paint.Align.CENTER);
        textPaint.setTextSize(DensityUtils.sp2px(getContext(), 25));
